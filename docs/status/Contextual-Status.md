...
- **Floor gating** is enforced via floor band metadata on moments.
...
- **iPhone 17 Pro sync**: reported not syncing on iOS 26.2; needs device support + Xcode pairing check.
...
- Product doc (reference):
  - `docs/references/Contextual Product Doc (13 Jan 2026).pdf`
- Internal product doc (Jan 26):
  - `docs/references/Internal_ Contextual Product Doc (Jan 26) (3).pdf`
